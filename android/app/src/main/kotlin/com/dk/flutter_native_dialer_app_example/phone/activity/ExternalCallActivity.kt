package com.dk.flutter_native_dialer_app_example.phone.activity
...
import com.dk.flutter_native_dialer_app_example.databinding.ActivityExternalCallBinding
...
import com.dk.flutter_native_dialer_app_example.phone.helper.getCallContact
import com.dk.flutter_native_dialer_app_example.phone.telecom.CallManager
import com.dk.flutter_native_dialer_app_example.phone.telecom.NoCall
...
class ExternalCallActivity : AppCompatActivity(), ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        callsViewModel.currentCall.observe(this) {
            if (it != null) {
                getCallContact(this, it) { callContact ->
                    callsViewModel.callContact.postValue(callContact)
                }
            }
        }
        ...
        when (requestCode) {
            4 -> {
                if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Snackbar.make(
                        this, binding.root, "Permission granted.",
                    ...
                    Snackbar.make(
                        this, binding.root, "Permission not granted.",
                        Snackbar.LENGTH_LONG
                    ).show()
